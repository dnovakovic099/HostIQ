...
export default function ListingOptimizationScreen({ navigation }) {
  ...
  const handleSelectProperty = async (property) => {
    ...
    // Try to load existing listing data and AI analysis
    try {
      ...
      if (response.data.success) {
        ...
        try {
          ...
          if (analysisResponse.data.success) {
            ...
            setAiFromCache(true);
            console.log('📦 Loaded existing AI analysis from', analysisResponse.data.analyzed_at);
          }
        } catch (analysisError) {
      ...
      // No existing data, show modal to enter URL
